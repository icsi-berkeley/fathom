...
importScripts('chrome://fathom/content/workers/chromelib/init.js');
importScripts('chrome://fathom/content/workers/chromelib/nsprmodules/socket.js');
importScripts('chrome://fathom/content/workers/chromelib/nsprmodules/broadcast.js');
