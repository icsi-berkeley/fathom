...
util.registerAction('udpOpenSendSocket');
util.registerAction('udpSend');
util.registerAction('udpOpenReceiveSocket');
util.registerAction('udpReceive');
util.registerAction('udpGetHostIP');
util.registerAction('udpGetPeerIP');

function udpOpenSendSocket() {
 ...
 * @param port
 */
function udpSend(socketid, msg, ip, port) {
...
function udpOpenReceiveSocket(port) {
  var fd = NSPR.sockets.PR_OpenUDPSocket(NSPR.sockets.PR_AF_INET);
